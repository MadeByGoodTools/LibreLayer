...
| LibreLayer Camera Raw recipe: `.libreRAW.json` | Yes | Yes | Portable validated development sidecar only; it contains no source image pixels and rejects unknown recipe versions or out-of-range settings. |
