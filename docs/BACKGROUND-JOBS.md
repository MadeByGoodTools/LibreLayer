...
2. It copies the layer pixels and records an in-flight browser-local journal marker.
...
6. Cancellation, timeout, worker failure, or invalid output leaves the original canvas untouched and clears the journal marker.
